    ...
    try {
      for (const productId of selectedProducts) {
        ...
        if (bulkUpdateData.buyPriceMultiplier) {
          updateData.buyPrice = product.buyPrice * bulkUpdateData.buyPriceMultiplier;
        }
        
        if (bulkUpdateData.sellPriceMultiplier) {
          updateData.sellPrice = product.sellPrice * bulkUpdateData.sellPriceMultiplier;
        }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Bulk Operations - {selectedProducts.length} Products Selected</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          {operation === 'update' && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="buyPriceMultiplier">Buy Price Multiplier</Label>
                  <Input
                    ...
                    onChange={(e) => setBulkUpdateData(prev => ({ 
                      ...prev, 
                      buyPriceMultiplier: e.target.value ? parseFloat(e.target.value) : undefined 
                    }))}
                  />
                </div>
                
                <div>
                  <Label htmlFor="sellPriceMultiplier">Sell Price Multiplier</Label>
                  <Input
                    ...
                    onChange={(e) => setBulkUpdateData(prev => ({ 
                      ...prev, 
                      sellPriceMultiplier: e.target.value ? parseFloat(e.target.value) : undefined 
                    }))}
                  />
                </div>
              </div>
          ...
          {operation === 'delete' && (
            <div className="space-y-4">
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <h4 className="font-medium text-red-800 mb-2">⚠️ Permanent Delete Warning</h4>
